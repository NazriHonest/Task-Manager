...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMPLETED', 'TASK_OVERDUE', 'TASK_REMINDER', 'COMMENT_ADDED', 'COMMENT_MENTION', 'PROJECT_INVITE', 'PROJECT_UPDATE', 'SYSTEM_ALERT');
